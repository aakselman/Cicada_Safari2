...
export default class two_of_4 extends React.Component 
{
    ...
    return (
      <ImageBackground  style={styles.container}>
          ...
          <View style={{alignContent:"center",top:65, position:"absolute", resizeMode:"stretch" , height:'55%' , width:'120%'}}>
              <Image style={{alignContent:"center", position:"absolute", resizeMode:"stretch" , height:'100%' , width:'100%'}} source={require('../assets/cicadas/nymphal_skins.jpg')}/>    
          </View>
          ...
          <Text style={{fontSize:20, fontFamily:"ariel",top:454,position:"absolute"}}    >Nymphal skin</Text>

          <TouchableOpacity style={styles.button1} onPress={()=>{alert("you clicked me")}}>
             <Button title="2/4>" onPress={()=>{this.props.navigation.navigate('three_of_4');}} color="#408ac9"/>
          </TouchableOpacity>
