...
export default class user_screen2 extends React.Component 
{
  ...
  constructor() 
  {
    ...
    this.user_info=
    {
      ...
      origin: User.currentUser.origin
    }
  }
  ...
  render() {
    return (
      ...
      <ImageBackground  source={require('../assets/image/user_screen2.png')}  style={styles.container}>
        ...
        <Text style={{fontSize:20, fontFamily:"ariel",top:330,position:"absolute"}} >Connected with: {this.user_info.origin}</Text>
    ...
    <TouchableOpacity style={styles.button8} onPress={()=>{alert("you clicked me")}}>
             <Button title="Log out" onPress={()=>{alert("you clicked me")}} color="#408ac9"/>
    </TouchableOpacity>
