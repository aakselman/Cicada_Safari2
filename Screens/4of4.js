...
export default class four_of_4 extends React.Component 
{
...
<View style={{alignContent:"center",top:65, position:"absolute", resizeMode:"stretch" , height:'55%' , width:'120%'}}>
    <Image style={{alignContent:"center", position:"absolute", resizeMode:"stretch" , height:'100%' , width:'100%'}} source={require('../assets/cicadas/adult.png')}/>    
...
<TouchableOpacity style={styles.button} onPress={()=>{alert("you clicked me")}}>
   ...
   <Text style={{fontSize:20, fontFamily:"ariel",top:454,position:"absolute"}}  > Adult Cicadas</Text>

    <TouchableOpacity style={styles.button1} onPress={()=>{alert("you clicked me")}}>
             <Button title="4/4>" onPress={()=>{this.props.navigation.navigate('rank_table');}} color="#408ac9"/>
    </TouchableOpacity>
